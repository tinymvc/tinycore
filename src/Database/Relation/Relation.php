 ...
 * @method QueryBuilder withExists(array|string $relations, ?Closure $callback = null)
 ...
 * @method QueryBuilder where(null|string|array|Closure $column = null, ?string $operator = null, mixed $value = null, ?string $boolean = null, bool $not = false)
 ...
 * @method QueryBuilder between($field, $value1, $value2, $type = '', $boolean = 'AND')
 * @method QueryBuilder notBetween($field, $value1, $value2)
 * @method QueryBuilder like($field, $data, $type = '', $boolean = 'AND')
 * @method QueryBuilder grouped(Closure $callback)
 * @method QueryBuilder select(array|string $fields = '*')
 * @method QueryBuilder selectSub(string|QueryBuilder|Closure $subquery, string $alias)
 ...
 * @method QueryBuilder withTrashed(bool $withTrashed = true)
