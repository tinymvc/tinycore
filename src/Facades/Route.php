 ...
 * @method static BaseRoute fireline(string $path, string $template, array $context = [])
 * @method static BaseRoute inertia(string $path, string $component, array $props = [])
 ...
 * @method static Router middleware(string|array $middleware)
 * @method static Router withoutMiddleware(string|array $middleware)
 * @method static Router name(string $name)
 * @method static Router as(string $name)
 * @method static Router prefix(string $name)
 * @method static Router path(string $name)
 * @method static Router method(string $name)
 * @method static Router callback(callable|string|array $callback)
